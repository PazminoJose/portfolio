export default function Jira() {
  return (
    ...
    >
      <linearGradient id="a">
        <stop offset=".18" stopColor="currentColor"></stop>
        <stop offset="1" stopColor="currentColor"></stop>
      </linearGradient>
      <linearGradient id="b" x1="98.031%" x2="58.888%" y1=".161%" y2="40.766%"></linearGradient>
      <linearGradient id="c" x1="100.665%" x2="55.402%" y1=".455%" y2="44.727%"></linearGradient>
      <path
